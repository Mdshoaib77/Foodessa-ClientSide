...
const ShopContextProvider = (props) => {
  ...
  const contextValue = { foods, currency, delivery_charges, token, setToken, navigate, cartItems, setCartItems, addToCart, getCartCount, getUserCart, updateQuantity, getCartAmount, backendUrl }
