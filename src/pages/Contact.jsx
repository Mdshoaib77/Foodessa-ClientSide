    ...
    <section className='max-padd-container mt-24'>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-col">
              ...
              <p className='flexStart gap-x-2'><FaLocationDot /> 123 Foodessa Street, Food City, FC 12345</p>
            </div>
            <div className="flex flex-col">
              <h5 className="h5 capitalize mr-4">email:</h5>
              <p className='flexStart gap-x-2'><FaEnvelope /> info@foodessa.com</p>
            </div>
            <div className="flex flex-col">
      ...
      <div class="py-20">
        ...
        <div class="w-full h-96 rounded-lg overflow-hidden shadow-md">
          <iframe className='w-full h-full' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100940.18159943166!2d-122.52000124311752!3d37.75767131487411!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan%20Francisco%2C%20CA%2C%20USA!5e0!3m2!1sen!2s!4v1732252435611!5m2!1sen!2s" allowfullscreen="" loading="lazy" ></iframe>
        </div>
      </div>
