...
import food4 from "../assets/food_46.png"
        ...
        <div className='max-padd-container'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-20 mb-16 rounded-2xl'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-7'>
              {/* Review Card */}
              <div className='glex flex-col gap-1 rounded-lg p-4 bg-deep'>
                ...
                <div className='flex mt-5'>
                  <img src={food1} alt="prdctImg" height={44} width={44} className='rounded aspect-square object-cover' />
                  <img src={food2} alt="prdctImg" height={44} width={44} className='rounded aspect-square object-cover' />
                </div>
              </div>
              <div className='glex flex-col gap-1 rounded-lg p-4 bg-deep'>
                <div className='flexBetween'>
                ...
                <p>Amazing experience! The meals were perfectly cooked, and the flavors blended beautifully. The delivery was on time, and the packaging kept everything warm. Will definitely order again!</p>
                <div className='flex mt-5'>
                  <img src={food4} alt="prdctImg" height={44} width={44} className='rounded aspect-square object-cover' />
                  <img src={food3} alt="prdctImg" height={44} width={44} className='rounded aspect-square object-cover' />
                </div>
              </div>
